...
public class WaitRoomPortal33 : MonoBehaviourPunCallbacks
{
    public GameObject StartPortal6;
    public Player Player;
    public GameManager gameManager;
    public bool timeSpawnEnd6 = false;
    ...
    private void OnTriggerStay2D(Collider2D collision)
    {
        ...
        if (collision.tag == "Player")
        {
            ...
            gameManager.readyToStart6 = true;
            ...
            if (gameManager.readyToStart3 == true && gameManager.readyToStart4 == true && gameManager.readyToStart5 == true && gameManager.readyToStart6 == true && gameManager.readyToStart7 == true && gameManager.readyToStart8 == true)
            {
                ...
                StartCoroutine(Ready6());
            }
            if (timeSpawnEnd6 == true)
            {
                Player.transform.position = new Vector2(StartPortal6.transform.position.x, StartPortal6.transform.position.y);
                portalAnimator.SetBool("Open", true);
                StartCoroutine(StopPortal6());
            }
    ...
    private void OnTriggerExit2D(Collider2D collision)
    {
        if (collision.tag == "Player")
        {
            gameManager.readyToStart6 = false;
        }
